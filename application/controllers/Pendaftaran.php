...
class Pendaftaran extends CI_Controller {
	...
	public function formpendaftaran()
	{
		...
		else
		{
			...
			//$idproses = $data['idprosespenerimaan'];
	...
	public function do_pendaftaran()
	{
		...
		else
		{
				...
				|| $this->input->post('inputAlamatOrtu')=='')
			{
				...
				if ($this->input->post('inputCelana')=='') $this->session->set_flashdata('ukurancelana_kosong','Ukuran Celana belum diisi');
			...
			//$nomorpendaftaran dikasih kondisi apabila sudah punya nopendaftaran maka nomor psb tetap logika !=''
