		<div class="form-group">
            <label for="inputKelompok" class="col-lg-2 control-label">Proses Penerimaan <span style="color:red;">*</span></label>
            <div class="col-lg-5">
              <input class="form-control" name="inputProsesPenerimaan" id="inputProsesPenerimaan" value="<?php echo ($proses ? $proses : ""); ?>" readonly/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputKelompok" class="col-lg-2 control-label">Kelompok <span style="color:red;">*</span></label>
            <div class="col-lg-5">
          ...
          <div class="form-group">
            <label for="inputTahunMasuk" class="col-lg-2 control-label">Tahun Masuk <span style="color:red;">*</span></label>
            <div class="col-lg-3">
