						...
						<div class="col-lg-12">
							...
							{ ?>
								<div class="panel-body">
									...
									<form class="form-horizontal" action="<?php echo base_url();?>admin/do_cetakexcel" method="post" target="_blank">
									...
									<button
									type="submit" class="btn btn-success btn-xs pull-right"><i class="icon-file-excel"></i> Cetak Excel</button>
									</form>

									<a role="button" class="btn btn-primary pull-right" href="<?php echo base_url();?>admin/tambahcalonsiswa"><i class="icon-plus-circle2"></i> Tambah Siswa</a>
