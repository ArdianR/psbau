			...
			<div class="page-title">
				...
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Update Data Calon Siswa</li>
					</ul>
				</div>
			</div>
			<!-- /page header -->
							...
							<fieldset>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<center><h4 class="panel-title"><strong>Update Data Calon Siswa</strong></h4></center>
									</div>
									<div class="panel-body">
										...
										<div class="form-group">
											<label for="inputDesa" class="col-lg-2 control-label">Desa</label>
											<div class="col-lg-5">
										...
										<div class="form-group">
											...
											<div class="col-lg-3">
												<input type="email" class="form-control" name="inputEmailSiswa" id="inputEmailSiswa" placeholder="example@mail.com" value="<?php echo ($emailsiswa ? $emailsiswa : "");?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-3">
												<input type="text" class="form-control" name="inputHPOrtu" id="inputHPOrtu" placeholder="0812564...." value="<?php echo ($hportu ? $hportu : "");?>">
											</div>
										</div>
