...
<head>
  ...
  <title>Cetak Bukti Pendaftaran | PSB MAU-MBI Amanatul Ummah</title>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <font size="5"><strong>MAU-MBI Amanatul Ummah Surabaya</strong></font><br />
            <strong>Jl. Siwalankerto Utara 56, Wonocolo, Surabaya<br>
              Telp. (022)1234567, (022)1234567 &nbsp;&nbsp;Fax. (022)1234567&nbsp;&nbsp;<br>
  ...
  <br><br>
      ...
      <table class="table" style="width:100%;border: 1px solid black;border-collapse: collapse;">
        ...
        <tr>
          ...
          <td>14.</td>
          <td>Berat Badan</td>
          <td colspan="2">: <?php echo $berat;?></td>
        </tr>
         <tr>
          <td></td>
          <td>15.</td>
          <td>Tinggi Badan</td>
          <td colspan="2">: <?php echo $tinggi;?></td>
        </tr>
         <tr>
          <td></td>
          <td>16.</td>
