	...
	public function addCalonSiswaFromAdmin()
	{
		...
		("
			INSERT INTO psb_calonsiswa (
				nopendaftaran, lembaga, kelompok, tahunmasuk, nisn, nik, noun, nama, panggilan, jeniskelamin, tmplahir, tgllahir, agama, suku, kondisi, warga, anakke, jsaudara, alamatsiswa, desa, rt, rw, kecamatan, kota, provinsi, kodepos, jarak, hpsiswa, emailsiswa, asalsekolah, noijasah, tglijasah, ketsekolah, darah, berat, tinggi, ukuransepatu, ukuranbaju, ukurancelana, kesehatan, namaayah, namaibu, almayah, almibu, statusayah, statusibu, tmplahirayah, tmplahiribu, tgllahirayah, tgllahiribu, pendidikanayah, pendidikanibu, pekerjaanayah, pekerjaanibu, penghasilanayah, penghasilanibu, emailayah, emailibu, alamatortu, hportu, hobi, foto, binsmt1, binsmt2, binsmt3, binsmt4, binsmt5, bingsmt1, bingsmt2, bingsmt3, bingsmt4, bingsmt5, matsmt1, matsmt2, matsmt3, matsmt4, matsmt5, ipasmt1, ipasmt2, ipasmt3, ipasmt4, ipasmt5, ipssmt1, ipssmt2, ipssmt3, ipssmt4, ipssmt5, agamasmt1, agamasmt2, agamasmt3, agamasmt4, agamasmt5, ppknsmt1, ppknsmt2, ppknsmt3, ppknsmt4, ppknsmt5, penjassmt1, penjassmt2, penjassmt3, penjassmt4, penjassmt5, senismt1, senismt2, senismt3, senismt4, senismt5, prestasi, statusfinalisasi, ts
			)
			VALUES(
				'$this->nopendaftaran',
				'$this->lembaga',
	...
	public function cariDataSiswa()
	{
		...
		("
			...
			WHERE lembaga='$this->lembaga' AND 
					...
					tahunmasuk = '$this->tahunmasuk' AND
					statusfinalisasi = 'y'
		");
		return $query; 
	}
